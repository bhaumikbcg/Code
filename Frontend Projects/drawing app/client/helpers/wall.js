...
var drawing = Meteor.shared.getDrawingMachine;
...
Template.wall.events({
    ...
    'click .clear': function clear() {
        var drawingMachine = Template.instance().drawingApp;
...
Template.wall.onRendered(function setInitialValues() {
    ...
    this.drawingApp = drawing(canvas);
    ...
    this.autorun(function runEveryTime() {
        ...
        if (this.drawingApp && Session.get('pristine')) {
            this.drawingApp.draw(data);
        }
    }.bind(this));
});
